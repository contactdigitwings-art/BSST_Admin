...
export default function Home() {
  ...
  const certificates = [
    ...
    { id: '80G', title: '80G Tax Exemption', location: 'Income Tax Dept', icon: ShieldCheck, pdfPath: '/80G Certificate.pdf.pdf', desc: 'This certificate allows our donors to claim a 50% tax deduction on their contributions. It makes supporting our medical missions financially efficient.', details: [{ label: 'URN', value: 'AACTB3060FF20219' }, { label: 'Benefit', value: '50% Tax Rebate' }] },
